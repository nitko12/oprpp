...
public class QueryParser {
    ...
    /**
     * Shows the list of attributes in that order;
     * 
     * @return is showing query
     */
    public boolean isShowingQuery() {
        return showingQuery;
    }
    ...
    /**
     * Returns list of attributes to show.
     * 
     * @return List<String>
     */
    public List<String> getShowingAttributes() {
