...
public class LinkedListIndexedCollectionTest {
    ...
    public void testConstructors() {
        ...
        col = new LinkedListIndexedCollection<Integer>(new LinkedListIndexedCollection<>());
        assertEquals(0, col.size());

        col = new LinkedListIndexedCollection<Integer>();
        for (int i = 0; i < 32; i++) {
            col.add(i);
        }

        LinkedListIndexedCollection<Integer> col2 = new LinkedListIndexedCollection<>(col);
    ...
    public void testIsEmpty() {
        new CollectionCommonTests<LinkedListIndexedCollection<String>>(LinkedListIndexedCollection::new).testIsEmpty();
    }

    @Test
    public void testSize() {
        new CollectionCommonTests<LinkedListIndexedCollection<String>>(LinkedListIndexedCollection::new).testSize();
    }

    @Test
    public void testContains() {
        new CollectionCommonTests<LinkedListIndexedCollection<String>>(LinkedListIndexedCollection::new).testContains();
    }

    @Test
    public void testToArray() {
        new CollectionCommonTests<LinkedListIndexedCollection<String>>(LinkedListIndexedCollection::new).testToArray();
    }

    @Test
    public void testForEach() {
        new CollectionCommonTests<LinkedListIndexedCollection<String>>(LinkedListIndexedCollection::new).testForEach();
    }

    @Test
    public void testAddAll() {
        new CollectionCommonTests<LinkedListIndexedCollection<String>>(LinkedListIndexedCollection::new).testAddAll();
    }

    @Test
    public void testAdd() {
        new CollectionCommonTests<LinkedListIndexedCollection<String>>(LinkedListIndexedCollection::new).testAdd();
    }

    @Test
    public void testClear() {
        new CollectionCommonTests<LinkedListIndexedCollection<String>>(LinkedListIndexedCollection::new).testClear();
    }
    ...
    public void testElementsGetter() {
        new CollectionCommonTests<LinkedListIndexedCollection<String>>(LinkedListIndexedCollection::new)
                .testElementsGetter();
    }
}
